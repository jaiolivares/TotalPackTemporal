...
export class AFCAtencionesCategoriaService {
  ...
  async download(dataExcel: any): Promise<void> {
    ...
    this._workbook.xlsx.writeBuffer().then((data) => {
      ...
      fs.saveAs(blob, 'Reporte Atenciones por Categoría.xlsx');
    });
  }
  ...
  private async createtable(dataExcel: any) {
    ...
    // Nombre del titulo
    titleCell.value = 'Reporte Atenciones por Categoría';
    ...
    subtitleCell1.value = 'Id Oficinas°';
    subtitleCell2.value = 'Sucursales';
    subtitleCell3.value = 'Serie o Categoría';
